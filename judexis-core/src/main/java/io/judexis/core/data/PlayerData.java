...
public final class PlayerData {
    ...
    private ErrorMeasurement latestErrorMeasurement;
    ...
    public ErrorMeasurement getLatestErrorMeasurement() { return latestErrorMeasurement; }
    public void setLatestErrorMeasurement(ErrorMeasurement latestErrorMeasurement) { this.latestErrorMeasurement = latestErrorMeasurement; }
