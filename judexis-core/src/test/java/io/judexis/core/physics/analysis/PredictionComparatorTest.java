...
class PredictionComparatorTest {
    ...
    void toleranceIncreasesWithPing() {
        ...
        MovementSnapshot snapshot = new MovementSnapshot(1L, 100L, 1.03D, 64.0D, 2.0D, 1.0D, 64.0D, 2.0D, 0.0F, 0.0F,
            true, true, false, false, false, false, 0.6D);
        MotionState predictedState = new MotionState(1.0D, 64.0D, 2.0D, 0.03D, 0.0D, 0.0D,
